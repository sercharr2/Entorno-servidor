...
_END;
        ...
        $query = "INSERT INTO `jugadas` (`codigousu`, `acierto`,`numCirculos`,`numColores`) VALUES ($codigo, '1', $cantidadCirculo, $cantidadColor)";
...
_END;
    ...
    for ($z = 0; $z < $cantidadCirculo; $z++) {
     ...
     $query = "INSERT INTO `jugadas` (`codigousu`, `acierto`,`numCirculos`,`numColores`) VALUES ($codigo, '0', $cantidadCirculo, $cantidadColor)";
    $result = $conn->query($query);
    if (!$result)
        die("Fatal Error");
...
_END;
    ...
    echo <<<_END
    <br>
    <form method="post" action="simon.final.4.php">
